...
public class ConsultaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Contar el número de filas en el cursor (es decir, el número de usuarios registrados)
        int numUsuarios = cursor.getCount();

        // Mostrar el número de usuarios en un TextView
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView numUsuariosTextView = findViewById(R.id.numUsuariosTextView);
        numUsuariosTextView.setText("Número de usuarios registrados: " + numUsuarios);
